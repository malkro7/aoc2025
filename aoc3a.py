"""Day 3: combined runner for part A and part B.

This file exposes two functions:
- `parta(lines) -> int` : compute the part A total from an iterable of input lines
- `partb(lines, k=12) -> int` : compute the part B total using subsequences of length `k`

The `main()` reads the input file once and calls both parts.
"""
